...
import { FaLinkedin, FaTelegram, FaEnvelope, FaInstagram, FaGithub, FaPhone } from 'react-icons/fa';
import Photo from '../assets/photo.jpg';
import Navbar from './Navbar';

export default function Home() {
  const socialLinks = [
    { icon: FaLinkedin, href: "https://linkedin.com/in/msi678", color: "#0077B5" },
    { icon: FaPhone, href: "tel:+919345199105", color: "#25D366" },
    { icon: FaEnvelope, href: "mailto:mohammedsulaiman678@gmail.com", color: "#D44638" },
    { icon: FaGithub, href: "https://github.com/Syu607", color: "#6e5494" },
    { icon: FaTelegram, href: "https://t.me/Zufisufi", color: "#0088cc" },
    { icon: FaInstagram, href: "https://www.instagram.com/worldofzufi", color: "#E1306C" },
  ];
      ...
      >
        ...
        >
          ...
          <h2 className='text-3xl sm:text-5xl font-semibold'>
            I&apos;m <span className='text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-700'>Mohammed Sulaiman</span>,
          </h2>
          <h3 className='text-2xl sm:text-3xl font-light text-gray-400'>Full Stack Developer & Security Analyst</h3>
          <p className='text-lg sm:text-xl text-gray-400'>Building secure, scalable applications with expertise in web development and cybersecurity</p>
          <motion.div
          ...
          >
            ...
            <motion.a
              href="public\MohammedSulaimanResume.pdf"
              target="_blank"
              rel="noopener noreferrer"
