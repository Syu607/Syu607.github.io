  ...
  const tabContent = [
    {
      icon: FaUser,
      title: "Profile",
      content: "Full Stack Developer & Security Analyst with expertise in web development, cybersecurity, data science, and IoT. Passionate about building secure, scalable applications and solving complex technical challenges."
    },
    {
      icon: FaGraduationCap,
      title: "Education",
      content: "Bachelor of Engineering in Computer Science, Visvesvaraya Technological University, CGPA: 8.20/10"
    },
    {
      icon: FaHeart,
      title: "Interests",
      content: "Cloud security, web development, machine learning, data analytics, IoT, and embedded systems. Passionate about cybersecurity and vulnerability assessment."
    },
    {
      icon: FaLightbulb,
      title: "Aspirations",
      content: "To excel in cloud security and full-stack development while advancing skills in data science and IoT. Committed to building secure, innovative solutions and contributing to the cybersecurity field."
    }
  ];
