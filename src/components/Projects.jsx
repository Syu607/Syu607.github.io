...
export default function Projects() {
  const projects = [
    {
      title: "Sanchara - Travel Recommendation Platform",
      description: "A scalable travel platform with optimized MongoDB database and responsive UI that increased user engagement by 35%",
      githubLink: "https://github.com/Syu607/Sanchara",
      imageUrl: "https://i.postimg.cc/LspVvt5Z/8460855.jpg"
    },
    {
      title: "Django Event Management System",
      description: "Event platform with automated workflows, role-based access control, and optimized database models that reduced admin workload by 30%",
      githubLink: "https://github.com/Syu607/EventManagement",
      imageUrl: "https://i.postimg.cc/x1t4kpt1/play-plus.jpg"
    },
    {
      title: "Personal Health Dashboard",
      description: "Health tracking application with interactive data visualizations, multi-factor authentication, and mobile-responsive UI",
      githubLink: "https://github.com/Syu607/HealthDashboard",
      imageUrl: "https://i.postimg.cc/XJJ3GywT/weather.jpg"
    },
    {
      title: "Ambulance Rescue & Accident Monitoring System",
      description: "IoT-based accident detection system with 98% accuracy in crash detection and GPS tracking that reduced response time by 90%",
      githubLink: "https://github.com/Syu607/AmbulanceRescue",
